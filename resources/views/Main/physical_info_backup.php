	...
	<table>
		<tr>
			...
			@foreach($all_physical_device_infos as $all_physical_device_info)
				...
				@elseif($all_physical_device_info->admin_status=="" && $all_physical_device_info->port_category == "Physical")
					<span style="color:blue">Disabled</span>	

				@elseif($all_physical_device_info->admin_status=="")
					<span>-</span>

				@else
					<span style="color:red"><b>Down</b></span>
				@endif
				</center></td>
				<td><center>
