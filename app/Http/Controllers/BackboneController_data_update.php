...
class BackboneController extends Controller
{
    ...
    public function insert_bb_data_view(){
        ...
        // return"";
        return view('backbone.insert',compact('host_names','bandwidth_data'));
    }
    ...
    public function hopwise_link(){
        ...
        return view('backbone.hopwise_link',compact('host_names'));
    }
    ...
    public function districtwise_link(){
        ...
        return view('backbone.districtwise_link',compact('district_names'));
    }
    ...
    public function bb_update_view(Request $request){
        ...
        return view('backbone.update',compact('host_names','bandwidth_data','bb_data'));
    }
